...
import { serializeForecast5days, serializeForecast12Hours } from './serializer';
...
export function getForecast5days(options) {

  /*   return (api.get(`http://dataservice.accuweather.com/forecasts/v1/daily/5day/${locationKey}`)
      .then(res => serializeForecast5days(res)) */

  return (serializeForecast5days({
